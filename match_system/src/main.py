...
class Pool:
    ...
    def check_match(self, a, b):
        ...
        a_max_if = a.waiting_time * 50
        b_max_if = b.waiting_time * 50
        return dt <= a_max_if and dt <= b_max_if
    ...
    def match_success(self, ps):
        ...
        cache.set(room_name, players, 60*60)
        for p in ps:
...
if __name__ == '__main__':
    ...
    print('Starting the match server...')
    server.serve()
    print('done.')